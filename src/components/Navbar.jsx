...
import { ChevronDown, Menu, X, User, UserPlus, LogOut, Activity, Shield, Home, Info, Phone, Briefcase } from 'lucide-react';
...
const Navbar = () => {
  ...
  const getNavigationItems = () => {
    if (!isAuthenticated) {
      ...
      const dashboardPath = userRole === 'patient' ? '/patient-dashboard' :
                           userRole === 'doctor' ? '/doctor-dashboard' :
                           userRole === 'therapist' ? '/therapist-dashboard' : '/patient-dashboard';
                    ...
                    >
                      ...
                      >
                        <div className="px-4 py-3 text-center border-b border-emerald-100/50 mb-3">
                          ...
                          <p className="text-xs text-gray-500 mt-1">Select your role to continue</p>
                        </div>
                                ...
                                >
                                  <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex-1">
                                      <h4 className="text-white font-bold text-base">{option.name}</h4>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-emerald-600 capitalize">{user.role} • Online</p>
                      </div>
                    </div>
                  </motion.div>
                )}
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  You'll be safely signed out of your AyurMitra account. Your wellness data will remain secure.
                </p>
              </div>
